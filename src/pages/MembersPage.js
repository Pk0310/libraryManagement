...
import backgroundImage from '../images/bg.jpg'; // Update the path
...
const MembersPage = () => {
  ...
  const cardStyle = {
    backgroundColor: 'steelblue', // Set card background color to transparent
  ...
  return (
    <div style={divStyle}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" style={containerStyle}>
        <h2 className="text-2xl font-semibold mb-4">List of Members</h2>
